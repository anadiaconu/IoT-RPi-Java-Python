...
#For Liquid Level Sensor we actually selected the Analog pin A2
...
while True:
    ...
    if reading != None:
        ...
        print("Liquid Level Reading = %f, Time = %s" % (reading , timeStamp))
    ...
    query = """insert into `liquidlevelreading`(TimeStamp,Reading) values('%s',%f)""" % (timeStamp,readingFloat)
