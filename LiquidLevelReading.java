...
public class LiquidLevelReading {
        public static void main(String[] args) throws Exception {
                String query = "SELECT `Serial`,`Reading` from `liquidlevelreading`"; // column names and table name is given here
                ...
                JFreeChart chart = ChartFactory.createAreaChart("Liquid Level Sensor", "Time Stamps", "Sensor Levels",
