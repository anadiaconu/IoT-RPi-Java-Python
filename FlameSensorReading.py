...
#For Flame Sensor we actually selected the Analog pin A1
...
#Intitializing the variable readingFloat
...
while True:
    ...
    if reading != None:
        ...
        print("Flame Reading = %f, Time = %s" % (reading , timeStamp))
    ...
    query = """insert into `flamereading`(TimeStamp,Reading) values('%s',%f)""" % (timeStamp,readingFloat)
